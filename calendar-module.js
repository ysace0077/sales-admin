...
class CalendarModule {
    ...
    formatAmount(amount) {
        ...
        if (isMobile) {
            // 모바일: 간소화된 표기 (4.0백만원 -> 4.0)
            if (absAmount >= 1000000) {
                return `${prefix}${(absAmount / 1000000).toFixed(1)}`;
            } else if (absAmount >= 10000) {
                return `${prefix}${Math.round(absAmount / 10000)}`;
            } else if (absAmount >= 1000) {
                return `${prefix}${Math.round(absAmount / 1000)}`;
            } else {
    ...
    createCustomerCard(group) {
        ...
        let cardHTML = `
            <div class="customer-card" style="background: white; border: none; border-radius: 16px; padding: 24px; transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1); position: relative; overflow: hidden; box-shadow: 0 2px 12px rgba(0, 0, 0, 0.06); border-left: 5px solid #667eea;">
                <style>
                    @media (max-width: 768px) {
                        .customer-card {
                ...
                <div class="customer-header" style="margin-bottom: 20px; padding-bottom: 16px; border-bottom: 2px solid #e9ecef;">
                    <div style="display: flex; align-items: center; gap: 12px; flex-wrap: wrap;">
                        ...
                        <div class="customer-title" style="font-size: 1.2em; font-weight: 700; color: #212529;">
                            ${customerName}
                        </div>
                        ${locationInfo ? `<div class="customer-location" style="font-size: 0.85em; color: #6c757d; padding: 6px 12px; background: #e9ecef; border-radius: 8px; font-weight: 600;">${locationInfo}</div>` : ''}
                    </div>
                </div>
                <div class="customer-info" style="display: flex; flex-direction: column; gap: 8px; font-size: 0.95em; line-height: 1.6;">
        `;
        ...
        if (firstRecord['판매일']) {
            ...
            cardHTML += `
                <div style="margin-bottom: 8px;">
                    <span class="info-label" style="font-weight: 700; color: #495057;">판매일:</span>
                    <span class="info-value" style="color: #212529; font-weight: 500; margin-left: 8px;">${formattedDate}</span>
                </div>
            `;
        }
        ...
        if (firstRecord['판매자']) {
            cardHTML += `
                <div style="margin-bottom: 8px;">
                    <span class="info-label" style="font-weight: 700; color: #495057;">판매자:</span>
                    <span class="info-value" style="color: #212529; font-weight: 600; margin-left: 8px;">${firstRecord['판매자']}</span>
                </div>
            `;
        }
        ...
        if (firstRecord['배송일'] || firstRecord['배송예정일']) {
            ...
            cardHTML += `
                <div style="margin-bottom: 12px;">
                    <span class="info-label" style="font-weight: 700; color: #495057;">배송일:</span>
                    <span class="info-value" style="color: #212529; font-weight: 500; margin-left: 8px;">${formattedDeliveryDate}</span>
                </div>
            `;
        }
        ...
        records.forEach((record, index) => {
            if (index > 0) {
                cardHTML += `<div class="product-separator" style="margin: 12px 0; border-top: 1px solid #e9ecef; padding-top: 12px;"></div>`;
            }
            ...
            if (productInfo) {
                cardHTML += `
                    <div style="margin-bottom: 8px;">
                        <span class="info-label" style="font-weight: 700; color: #495057;">상품:</span>
                        <span class="info-value" style="color: #667eea; font-weight: 600; margin-left: 8px;">${productInfo}</span>
                    </div>
                `;
            }
            ...
            if (record['구매용도']) {
                cardHTML += `
                    <div style="margin-bottom: 8px;">
                        <span class="info-label" style="font-weight: 700; color: #495057;">구매용도:</span>
                        <span class="info-value" style="color: #212529; font-weight: 500; margin-left: 8px;">${record['구매용도']}</span>
                    </div>
                `;
            }
            ...
            if (record['할인가'] || record['출고가']) {
                ...
                cardHTML += `
                    <div style="margin-bottom: 8px;">
                        <span class="info-label" style="font-weight: 700; color: #495057;">금액:</span>
                        <span class="info-value" style="color: #10b981; font-weight: 700; font-family: 'SF Mono', Monaco, 'Courier New', monospace; margin-left: 8px;">
            ...
            if (paymentInfo) {
                cardHTML += `
                    <div style="margin-bottom: 8px;">
                        <span class="info-label" style="font-weight: 700; color: #495057;">결제:</span>
                        <span class="info-value" style="color: #212529; font-weight: 500; margin-left: 8px;">${paymentInfo}</span>
                    </div>
                `;
            }
            ...
            if (discountRate) {
                cardHTML += `
                    <div style="margin-bottom: 8px;">
                        <span class="info-label" style="font-weight: 700; color: #495057;">할인율:</span>
                        <span class="info-value" style="color: #f97316; font-weight: 700; font-family: 'SF Mono', Monaco, 'Courier New', monospace; margin-left: 8px;">${discountRate}</span>
                    </div>
                `;
            }
        });
