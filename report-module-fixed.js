        ...
        return `
            ...
            <div style="background: white; border-radius: 15px; padding: 20px; box-shadow: 0 5px 20px rgba(0,0,0,0.1);">
                ...
                <div id="aceCharts" style="display: block;">
                    ...
                    <div class="charts-grid">
                        <div class="chart-card">
                            <h3 class="chart-title">17. 연계품목 판매 금액</h3>
                            <div class="chart-container"><canvas id="relatedItemSalesChart"></canvas></div>
                        </div>
                        <div class="chart-card">
                            <h3 class="chart-title">18. 연계품목 판매 수량</h3>
    ...
    loadData() {
        try {
            ...
            if (this.currentTable === 'data_(ACE)') {
                ...
                this.loadRelatedItemCharts(filter, prevYear); // 연계품목 차트 추가
            } else {
